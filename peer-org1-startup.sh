...
export CORE_PEER_TLS_ROOTCERT_FILE = /Users/jc/Documents/project/hyperledger/hyfa/native-network/config/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp/tlscacerts/tlsca.org1.example.com-cert.pem
